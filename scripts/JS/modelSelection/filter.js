...
function filterElements(inputDate, sliceRange=10) {
    ...
    let filteredElementsAfterSearch = elementsCollection.search(filteredElementsArray);
    elementsContainer.replaceChildren(...filteredElementsAfterSearch.slice(0, sliceRange));
    sortValues();
